...
class Objekt:
    ...
    def referanseLokasjonPunkt(self):
        """Returnerer lokasjon for første punkt for første veglenke"""
        veglenker = self.veglenker()
        params = { 'id' : veglenker[0]['id'],
                    'posisjon' : veglenker[0]['fra']
                    }
        lokasjon = query( '/vegreferanse/lenke', params=params)
        return lokasjon
